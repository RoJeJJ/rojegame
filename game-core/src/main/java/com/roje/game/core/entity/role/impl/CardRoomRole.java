...
@Slf4j
public class CardRoomRole extends RoomRole {

    private final CardRoomManager roomManager;

    private final List<CardRoom> createRooms;

    public CardRoomRole(long id, String account, String nickname, String avatar, long card, long gold, CardRoomManager roomManager) {
